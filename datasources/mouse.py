...
class MouseData:
    def __init__(self, inpRes=256):
        self.labelPathname = "{}/data/pose/Sniffing/croppeds_bbox/labels_normal.json".format(glob.root)
        self.imgPath = "{}/data/pose/Sniffing/croppeds_bbox/images".format(glob.root)
        self.imgType = "png"
        self.inpRes = inpRes
