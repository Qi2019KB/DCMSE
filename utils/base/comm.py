...
class CommUtils:
    ...
    @classmethod
    def ckpt_load(cls, ckptPath='ckpts'):
        best_filename = "checkpoint_best.pth.tar"
        checkpoint = torch.load("{}/{}".format(ckptPath, best_filename))
        return checkpoint
