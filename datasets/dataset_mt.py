...
class MTDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, dsType, dataArray, means, stds, isAug=False, isDraw=False, **kwargs):
        self.dsType, self.dataArray, self.dataArray_reset, self.means, self.stds, self.isAug, self.isDraw = dsType, copy.deepcopy(dataArray), copy.deepcopy(dataArray), means, stds, isAug, isDraw
        ...
        self.useOcc_ema, self.sf_ema, self.rf_ema, self.isAug_ema = kwargs['useOcclusion_ema'], kwargs['scaleRange_ema'], kwargs['rotRange_ema'], kwargs['isAug_ema']
        if self.isAug:
            if self.useOcc:
